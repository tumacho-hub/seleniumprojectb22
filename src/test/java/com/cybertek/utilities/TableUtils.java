 ...
 */
    ...
    public static void verifiedOrder(WebDriver driver, String name) {
        // we are storing all the names here in this List<WeblEment
        ...
        for (WebElement each : allNames) {
            if (each.getText().equals(name)) {
                ...
                return;
//        }else
//            Assert.assertTrue(false, "given name is not on the web table");
            }
